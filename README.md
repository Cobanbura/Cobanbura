...
<p align="left">
  ...
  <!-- Version Control -->
  <a href="https://git-scm.com/" target="_blank"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/git/git-original.svg" alt="Git" width="40" height="40" hspace="5"/></a>
</p>
...
* 🎓 **Graduated in Naval Architecture & Ocean Engineering** — though somehow I ended up steering game engines instead of ships.
* 🤖 **Former ROV Team Leader/Member** — spent 3+ years designing and building underwater robotics.
* 📱 **Mobile Game Development (2019 - Jan 2024)** — worked as a Unity Developer crafting mobile games (C#).
* 🧪 **QA Automation Specialist (May 2024 - Aug 2025)** — designed and executed automated test frameworks to ensure product quality.
* 🎮 **Indie Projects & Steam Focus** — actively working on indie game prototypes and hobby projects targeting Steam in my free time.
* 🌱 **Always Exploring** — diving deeper into the Godot engine and modern development patterns.
* 📍 **Based in Istanbul** — open to remote work and global opportunities.
